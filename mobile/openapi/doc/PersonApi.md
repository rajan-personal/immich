...
# **getAllPeopleFromAlbum**
> PeopleResponseDto getAllPeopleFromAlbum(id, withHidden)
...
try {
    final result = api_instance.getAllPeopleFromAlbum(id, withHidden);
    print(result);
} catch (e) {
    print('Exception when calling PersonApi->getAllPeopleFromAlbum: $e\n');
}
```
