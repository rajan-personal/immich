...
from .clip import MCLIPEncoderOnnx, OpenCLIPEncoderAnn, OpenCLIPEncoderOnnx
from .constants import is_ann, is_insightface, is_mclip, is_openclip
    ...
    match model_type:
        case ModelType.CLIP:
            if is_openclip(model_name):
                if is_ann(model_name):
                    return OpenCLIPEncoderAnn(model_name, **model_kwargs)
                else:
